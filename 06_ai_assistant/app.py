...
MODEL_NAME   = os.getenv("MLFLOW_MODEL_NAME",   "mi_modelo")
...
def cargar_recursos():
    try:
        ...
        mod_buy = mlflow.pyfunc.load_model(f"models:/buy_model/Production")
        mod_rent = mlflow.pyfunc.load_model(f"models:/rent_model/Production")
